...
#  python gunicorn app.main:app -w 2 -k uvicorn.workers.UvicornWorker
...
# 限制HTTP请求中请求头字段的数量。默认情况下，这个值为100，这个值不能超过32768
...
pythonpath = '/home/ubuntu/virtualenv/fastapi-vue-autobots/bin/python3'
